              ...
              <div className="flex-center w-full">
                <Card>
                  <div className="flex-row aktuality-image-mobile">
                    <div>
                      <Image src={christmasPoster} width="707" height="1000" alt="hero" />
                    </div>
                  </div>
                  <div className="flex-row">
                    ...
                    <div className="flex-col py-4 sm:py-8 px-5 sm:p-12">
                      ...
                      <Link href="https://goo.gl/maps/jK9t1LQVwxrZCzfk6">
                        <a target="_blank" rel="noreferrer noopener">
                          <div className="flex-row">
                            <div className="flex-col">
                            ...
                            <div className="flex-col">
                              <span className="text-base sm:text-xl">17.12. 2022 Bar Alfa Frýdek Místek</span>
                            </div>
                          </div>
                        </a>
                      </Link>
                      <div className="aktuality-p flex-row mt-6">
                        <p>
                          Rock 'n' Roll Christmas aneb vánoční besídka pro všechny kluky a holky. Pravý rockový advent v lehčím i tvrdším rockovém podání kde si každý najde to své.
                        </p>
                      </div>
                ...
                <div key={person.name} className="person flex-col">
                  <Card>
                    <div className="flex-row flex-center">
                      ...
                      {i == 3 && <Image src={izzy} width="400" height="266" alt="hero" priority={true} />}
                    </div>
